...
"48143":("BIS FS","erath-cad.com; 5 deed-history rows/parcel (123,794 rows/24,656 parcels) — not a bug, just needed a longer fetch window. sale 23,772 (geo join)"),
...
"48417":("PACS print-report","load_pacs_print_report.py parses the human-readable roll (header-line regex + forward-scan for Exemptions:); exempt 962 (join apn==geo, 85%, spot-checked)"),
